...
MODEL_DIR = f"{PROJECT_ROOT}/models/openbmb/MiniCPM-o-2_6"
DATA_PATH = f"{PROJECT_ROOT}/splits/split_v3/swift_train.jsonl"
OUTPUT_DIR = f"{PROJECT_ROOT}/runs/minicpm_o_lora_a100"
...
def main():
    ...
    args = SwiftTrainArguments(
        model=MODEL_DIR,
        dataset=[DATA_PATH],
        output_dir=OUTPUT_DIR,
        
        # 🌟 指定绝对路径继续续传
        resume_from_checkpoint="/root/autodl-tmp/project_douyin_mm/runs/minicpm_o_lora_a100/v1-20260307-115831/checkpoint-1500",
    ...
    print("🚀 [CSS-Project] 启动 MiniCPM-o 2.6 (A800 断点续传 1500步) 多模态微调...")
