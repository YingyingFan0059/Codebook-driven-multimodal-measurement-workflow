...
BASE_MODEL_PATH = os.path.join(PROJECT_ROOT, "models/openbmb/MiniCPM-o-2_6")
LORA_PATH = os.path.join(PROJECT_ROOT, "runs/minicpm_o_lora_a100/v3-20260308-015640/checkpoint-1875") 
...
TEST_FILES = {"MainTest": os.path.join(PROJECT_ROOT, "splits/split_v3/test_main.csv")}
