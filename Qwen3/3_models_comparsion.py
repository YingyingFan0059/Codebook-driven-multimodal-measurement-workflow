...
"""
Qwen2-VL-7B / InternVL2-8B / Qwen3-Omni-30B 绘图脚本
...
INTERNVL_CSV = os.path.join(
    PROJECT_ROOT,
    "outputs/scaling_eval/eval_internvl_lora_5class_2200_predictions.csv"
)
...
# 颜色统一
MODEL_COLORS = {
    "Qwen2-VL-7B": "#1f77b4",      # 蓝
    "InternVL2-8B": "#ff7f0e",     # 橙
    "Qwen3-Omni-30B": "#6a3d9a",   # 紫
}

MODEL_CMAPS = {
    "Qwen2-VL-7B": "Blues",
    "InternVL2-8B": "Oranges",
...
def plot_bar_chart(models_metrics, out_filename):
    ...
    ax.set_title("Performance Comparison: Qwen2-VL-7B vs InternVL2-8B vs Qwen3-Omni-30B", pad=16)
...
if __name__ == "__main__":
    ...
    internvl_metrics = get_metrics_from_csv(INTERNVL_CSV)
    qwen3_metrics = get_metrics_from_csv(QWEN3_CSV)

    models_metrics = {
        "Qwen2-VL-7B": qwen2_metrics,
        "InternVL2-8B": internvl_metrics,
        "Qwen3-Omni-30B": qwen3_metrics,
    }

    plot_bar_chart(models_metrics, "qwen2_internvl_qwen3_bar.png")
    plot_confusion_matrices(models_metrics, "qwen2_internvl_qwen3_confusion_matrix.png")

    plot_single_radar("Qwen2-VL-7B", qwen2_metrics, "qwen2_only_radar.png")
    plot_single_radar("InternVL2-8B", internvl_metrics, "internvl_only_radar.png")
