...
# 修正：真实目录多了一层 internvl
BASE_MODEL_PATH = os.path.join(PROJECT_ROOT, "models/internvl/InternVL2-8B")
...
# 输出到复现文件夹
OUTPUT_EVAL_DIR = os.path.join(PROJECT_ROOT, "outputs/scaling_eval_repro")
