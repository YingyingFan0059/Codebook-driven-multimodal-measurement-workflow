...
INPUT_PATH = os.environ.get(
    "QWEN3_SWIFT_TRAIN_INPUT",
    f"{PROJECT_ROOT}/splits/split_v3/swift_train.jsonl"
)
OUTPUT_PATH = os.environ.get(
    "QWEN3_SWIFT_TRAIN_FIXED",
    f"{PROJECT_ROOT}/splits/split_v3/swift_train_v2.jsonl"
)
BACKUP_PATH = os.environ.get(
    "QWEN3_SWIFT_TRAIN_BACKUP",
    f"{PROJECT_ROOT}/splits/split_v3/swift_train_v1_backup.jsonl"
)
