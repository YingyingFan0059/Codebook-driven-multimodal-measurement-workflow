...
# 对齐 Qwen2-VL-7B: 8帧
os.environ.setdefault("FPS_MAX_FRAMES", "8")
os.environ.setdefault("MAX_PIXELS", "150000")
...
MODEL_DIR = os.environ.get(
    "QWEN3_MODEL_DIR",
    f"{PROJECT_ROOT}/models/qwen/Qwen3-Omni-30B-A3B-Instruct"
)
TRAIN_DATA = os.environ.get(
    "QWEN3_TRAIN_DATA",
    f"{PROJECT_ROOT}/splits/split_v3/swift_train_2200.jsonl"
)
EVAL_DATA = os.environ.get(
    "QWEN3_EVAL_DATA",
    f"{PROJECT_ROOT}/splits/split_v3/swift_eval.jsonl"
)
OUTPUT_DIR = os.environ.get(
    "QWEN3_OUTPUT_DIR",
    f"{PROJECT_ROOT}/runs/qwen3_omni_lora_aligned_v2"
)
...
def validate_data(data_path):
    if not os.path.exists(data_path):
        ...
        print("[ERROR] 请先生成训练 JSONL，或通过 QWEN3_TRAIN_DATA 指定路径。")
        sys.exit(1)
